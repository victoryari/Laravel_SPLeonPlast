        ...
        <form action="{{ route('usuarios.update', $usuario->id_usuario) }}" method="POST">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="col-span-1">
                    ...
                    <input type="text" name="nombre_usuario" id="nombre_usuario" value="{{ old('nombre_usuario', $usuario->nombre_usuario) }}" 
                ...
                <div class="col-span-1">
                    <label for="password" class="block text-sm font-medium text-gray-700 mb-1">
                        Nueva Contraseña <span class="text-xs text-gray-400 font-normal">(Dejar vacío para no cambiar)</span>
                    </label>
                ...
                <div class="col-span-1 md:col-span-2">
                    ...
                    <select name="codigo_trabajador" id="codigo_trabajador" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-primary focus:border-primary">
            ...
            <div class="flex justify-end space-x-3 pt-6">
                ...
                <button type="submit" class="px-6 py-2 bg-blue-600 text-white rounded-lg hover:bg-primary-dark shadow-md transition font-semibold">Actualizar Usuario</button>
            </div>
        </form>
    </div>
</div>
