...
<div class="container mx-auto pb-8 md:pb-10">
    <div class="mb-8">
        <h1 class="text-2xl md:text-3xl font-bold text-slate-800">Panel de Control - Supervisor</h1>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <div class="bg-white rounded-2xl shadow-sm border border-slate-100 p-6 border-b-4 border-b-blue-500">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-black text-slate-800 mt-2">{{ $ordenesActivas }}</p>
                </div>
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-slate-100 p-6 border-b-4 border-b-yellow-500">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-xs font-bold text-slate-400 uppercase tracking-wider">Pendientes de Validar</p>
                    <p class="text-3xl font-black text-slate-800 mt-2">{{ $pendientesValidar }}</p>
                </div>
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-slate-100 p-6 border-b-4 border-b-green-500">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-xs font-bold text-slate-400 uppercase tracking-wider">Producción del Día</p>
                    <p class="text-3xl font-black text-slate-800 mt-2">{{ number_format($produccionDia, 0) }} <span class="text-sm font-medium text-slate-500">Kg</span></p>
                </div>
            ...
            <div class="overflow-x-auto">
                <table class="w-full text-left text-xs">
                    ...
                    <tbody class="divide-y divide-slate-100">
                        ...
                        @empty
                        <tr><td colspan="3" class="px-4 py-4 text-center text-slate-400">Sin órdenes activas</td></tr>
                        @endforelse
                    </tbody>
                </table>
            </div>
            ...
            <div class="overflow-x-auto">
                <table class="w-full text-left text-xs">
                    ...
                    <tbody class="divide-y divide-slate-100">
                        ...
                        @empty
                        <tr><td colspan="3" class="px-4 py-4 text-center text-slate-400">Sin recepciones pendientes</td></tr>
                        @endforelse
                    </tbody>
                </table>
            </div>
