            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div class="md:col-span-2">
                    ...
                    <input type="text" name="codigo" id="codigo" value="{{ old('codigo') }}" 
                           class="w-full px-4 py-3 rounded-xl border @error('codigo') border-red-500 @else border-gray-300 @enderror focus:ring-2 focus:ring-primary focus:border-primary outline-none transition" 
                ...
                <div class="md:col-span-2">
                    ...
                    <input type="text" name="nombre" id="nombre" value="{{ old('nombre') }}" 
                           class="w-full px-4 py-3 rounded-xl border @error('nombre') border-red-500 @else border-gray-300 @enderror focus:ring-2 focus:ring-primary focus:border-primary outline-none transition" 
