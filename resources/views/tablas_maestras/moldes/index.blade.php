                ...
                <table class="w-full text-left border-collapse text-xs sm:text-sm">
                    <thead>
                        <tr class="bg-slate-900 text-slate-200 text-xs uppercase tracking-wider font-bold">
                            ...
                            <th class="p-4 border-r border-slate-800 text-center">Descripción del Molde</th>
                    ...
                    <tbody class="divide-y divide-slate-100 text-xs md:text-sm">
                        @forelse ($moldes as $molde)
                            <tr class="hover:bg-slate-50/50 transition">
                                <td class="px-4 md:px-6 py-3 md:py-4 font-bold text-slate-900">{{ $molde->codigo }}</td>
                                <td class="px-4 md:px-6 py-3 md:py-4 text-slate-700">{{ $molde->descripcion }}</td>
