        ...
        <form action="{{ route('productos.update', $producto->codigo) }}" method="POST">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div class="col-span-1">
                    ...
                    <input type="text" value="{{ $producto->codigo }}" class="w-full px-4 py-2 border border-gray-300 bg-gray-100 text-gray-500 rounded-lg cursor-not-allowed" disabled readonly>
                    <p class="text-xs text-gray-500 mt-1"><i class="fas fa-info-circle"></i> El código no es editable.</p>
                </div>
                ...
                <div class="col-span-1">
                    ...
                    <select name="codigo_tipo_producto" id="codigo_tipo_producto" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-yellow-500 focus:border-yellow-500 @error('codigo_tipo_producto') border-red-500 @enderror" required>
                ...
                <div class="col-span-1 md:col-span-2">
                    ...
                    <input type="text" name="descripcion" id="descripcion" value="{{ old('descripcion', $producto->descripcion) }}" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-yellow-500 focus:border-yellow-500 @error('descripcion') border-red-500 @enderror" placeholder="Nombre o detalle del artículo" maxlength="150">
                    @error('descripcion')
                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="col-span-1">
                    ...
                    <select name="codigo_unidad_medida" id="codigo_unidad_medida" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-yellow-500 focus:border-yellow-500 @error('codigo_unidad_medida') border-red-500 @enderror">
                ...
                <div class="col-span-1 md:col-span-2 flex items-center mt-2 bg-slate-50 p-4 rounded-lg border border-slate-200">
                    ...
                    <input type="checkbox" name="es_producto_proceso" id="es_producto_proceso" value="1" {{ old('es_producto_proceso', $producto->es_producto_proceso) == '1' ? 'checked' : '' }} class="w-5 h-5 text-yellow-600 bg-white border-gray-300 rounded focus:ring-yellow-500 focus:ring-2 cursor-pointer">
