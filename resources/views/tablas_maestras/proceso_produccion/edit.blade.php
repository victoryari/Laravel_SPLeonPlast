...
<div class="container mx-auto max-w-2xl">
    <div class="mb-6 flex items-center justify-between">
        <h1 class="text-2xl font-bold text-gray-800">Editar Proceso</h1>
    </div>
    ...
    <div class="bg-white rounded-xl shadow-md p-6 border-t-4 border-yellow-500">
        <form action="{{ route('procesos_produccion.update', $proceso->codigo) }}" method="POST">
            ...
            <div class="mb-5">
                ...
                <input type="text" value="{{ $proceso->codigo }}" class="w-full px-4 py-2 border border-gray-300 bg-gray-100 text-gray-500 rounded-lg cursor-not-allowed" disabled readonly>
                <p class="text-xs text-gray-500 mt-1"><i class="fas fa-info-circle"></i> El código es único y no se puede modificar.</p>
            </div>
            ...
            <div class="mb-6">
                ...
                <input type="text" name="descripcion" id="descripcion" value="{{ old('descripcion', $proceso->descripcion) }}" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-yellow-500 focus:border-yellow-500 @error('descripcion') border-red-500 @enderror" maxlength="150" required>
                @error('descripcion')
            ...
            <div class="mb-6">
                ...
                <select name="codigo_almacen" id="codigo_almacen" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-yellow-500 focus:border-yellow-500 @error('codigo_almacen') border-red-500 @enderror">
