    ...
    <div class="bg-white rounded-xl shadow-md p-6 border-t-4 border-blue-500">
        <form action="{{ route('procesos_produccion.store') }}" method="POST">
            ...
            <div class="mb-5">
                ...
                <input type="text" name="codigo" id="codigo" value="{{ old('codigo') }}" class="w-full px-4 py-2 border border-gray-300 rounded-lg uppercase focus:ring-blue-500 focus:border-blue-500 @error('codigo') border-red-500 @enderror" placeholder="Ej: PROC-01" maxlength="15" required>
                @error('codigo')
            ...
            <div class="mb-6">
                ...
                <input type="text" name="descripcion" id="descripcion" value="{{ old('descripcion') }}" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 @error('descripcion') border-red-500 @enderror" placeholder="Nombre o detalle del proceso" maxlength="150" required>
                @error('descripcion')
                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                @enderror
            </div>
