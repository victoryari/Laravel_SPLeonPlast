    ...
    <div class="bg-white rounded-xl shadow-md p-6 border-t-4 border-yellow-500">
        <form action="{{ route('tipos_producto.update', $tipo->codigo) }}" method="POST">
            ...
            <div class="mb-5">
                ...
                <input type="text" id="codigo" value="{{ $tipo->codigo }}" class="w-full px-4 py-2 border border-gray-300 bg-gray-100 text-gray-500 rounded-lg cursor-not-allowed" disabled readonly>
            ...
            <div class="mb-6">
                ...
                <input type="text" name="descripcion" id="descripcion" value="{{ old('descripcion', $tipo->descripcion) }}" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-yellow-500 focus:border-yellow-500 @error('descripcion') border-red-500 @enderror" maxlength="100" required>
                @error('descripcion')
