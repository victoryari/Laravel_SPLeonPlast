            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div class="md:col-span-2">
                    ...
                    <input type="text" name="ruc" id="ruc" value="{{ old('ruc') }}" 
                           class="w-full px-4 py-3 rounded-xl border @error('ruc') border-red-500 @else border-gray-300 @enderror focus:ring-2 focus:ring-primary focus:border-primary outline-none transition" 
                ...
                <div class="md:col-span-2">
                    ...
                    <input type="text" name="razon_social" id="razon_social" value="{{ old('razon_social') }}" 
                           class="w-full px-4 py-3 rounded-xl border @error('razon_social') border-red-500 @else border-gray-300 @enderror focus:ring-2 focus:ring-primary focus:border-primary outline-none transition" 
