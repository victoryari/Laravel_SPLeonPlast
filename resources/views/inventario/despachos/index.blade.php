            ...
            <table class="w-full text-left whitespace-nowrap">
                <thead>
                    <tr class="bg-slate-900 text-slate-200 text-xs uppercase tracking-wider font-bold">
                        ...
                        <th class="px-4 md:px-6 py-3.5 border-r border-slate-800">Productos a Despachar</th>
                        <th class="px-4 md:px-6 py-3.5 border-r border-slate-800">Solicitado Por</th>
