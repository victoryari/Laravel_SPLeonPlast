        ...
        <form method="GET" action="{{ route('inventario.transferencias.index') }}" class="w-full flex flex-col md:flex-row gap-4">
            ...
            <div class="flex items-center gap-2">
                <div class="flex flex-col">
                    ...
                    <input type="date" name="fecha_desde" value="{{ $fecha_desde }}" class="border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-blue-500 outline-none">
                </div>
                <div class="flex flex-col">
                    <label class="text-[10px] uppercase text-gray-500 font-bold mb-1">Fecha Hasta</label>
                    <input type="date" name="fecha_hasta" value="{{ $fecha_hasta }}" class="border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-blue-500 outline-none">
                </div>
            </div>
