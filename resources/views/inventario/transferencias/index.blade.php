...
<div class="container mx-auto pb-8 md:pb-10">
    ...
    <div class="bg-white p-3 md:p-4 rounded-xl shadow-sm border border-slate-200 mb-6 flex items-center justify-between">
        <form method="GET" action="{{ route('inventario.transferencias.index') }}" class="relative w-full sm:w-96">
