...
<div class="container mx-auto pb-8 md:pb-10">
    <div class="mb-8">
        <h1 class="text-2xl md:text-3xl font-bold text-gray-800">Panel de Control - Almacén</h1>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 border-b-4 border-b-blue-500">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-xs font-bold text-gray-400 uppercase tracking-wider">Requerimientos Pdtes.</p>
                    <p class="text-3xl font-black text-gray-800 mt-2">{{ $reqsPendientes }}</p>
                </div>
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 border-b-4 border-b-red-500">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-xs font-bold text-gray-400 uppercase tracking-wider">Stock Crítico</p>
                    <p class="text-3xl font-black text-gray-800 mt-2">{{ $alertasStock }}</p>
                </div>
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 border-b-4 border-b-green-500">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-xs font-bold text-gray-400 uppercase tracking-wider">Recepciones Pdtes.</p>
                    <p class="text-3xl font-black text-gray-800 mt-2">{{ $recepcionesPend }}</p>
                </div>
            ...
            <div class="overflow-x-auto">
                <table class="w-full text-left text-xs">
                    ...
                    <tbody class="divide-y divide-gray-100">
                        ...
                        @empty
                        <tr><td colspan="3" class="px-4 py-4 text-center text-gray-400">No hay requerimientos recientes</td></tr>
                        @endforelse
                    </tbody>
                </table>
            </div>
            ...
            <div class="overflow-x-auto">
                <table class="w-full text-left text-xs">
                    ...
                    <tbody class="divide-y divide-gray-100">
                        ...
                        @empty
                        <tr><td colspan="3" class="px-4 py-4 text-center text-gray-400">Sin movimientos recientes</td></tr>
                        @endforelse
                    </tbody>
                </table>
            </div>
